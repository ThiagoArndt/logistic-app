...
import handler from "@/src/pages/api/products/read";
...
describe("/api/products/read", () => {
  ...
  it("get all products in database", async () => {
    ...
    if (allproducts == null) {
      ...
      expect(response.data).toEqual(allproducts);
    }
  });
});
